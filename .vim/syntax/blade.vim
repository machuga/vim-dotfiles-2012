...
syntax region bladeLoop start=/@unless/ end=/@endunless/ contains=@phpBladeContainer
...
syntax region bladeLoop start=/@foreach/ end=/@endforeach/ contains=@phpBladeContainer
